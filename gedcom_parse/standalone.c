...
/* $Id: standalone.c,v 1.13 2003/02/01 17:03:19 verthezp Exp $ */
/* $Name: R0_90_0 $ */
...
{
  fprintf(stderr,
	"\033[38;5;45m  [trace]\033[0m "         // cyan-ish for [trace]
	"\033[38;5;220m%10s:%-5d\033[0m "      // yellow-ish for file:line
	"\033[38;5;82m%32s()\033[0m "          // green-ish for function
	"\033[38;5;202mSRIDHAR - \033[0m\n",  // orange-ish for message
...
int main(int argc, char* argv[])
{
  fprintf(stderr,
	...
	"\033[38;5;220m%10s:%-5d\033[0m "      // yellow-ish for file:line
	"\033[38;5;82m%32s()\033[0m "          // green-ish for function
	"\033[38;5;202mSRIDHAR - beginning of main method\033[0m\n",  // orange-ish for message
	__FILE__, __LINE__, __func__);
...
fprintf(stderr,
  ...
  while (run_times-- > 0) {
	...
	"\033[38;5;220m%10s:%-5d\033[0m "      // yellow-ish for file:line
	"\033[38;5;82m%32s()\033[0m "          // green-ish for function
	"\033[38;5;202mSRIDHAR - file_name = %s\033[0m\n",  // orange-ish for message
	__FILE__, __LINE__, __func__, simple_base_name(file_name));
	...
	"\033[38;5;220m%10s:%-5d\033[0m "      // yellow-ish for file:line
	"\033[38;5;82m%32s()\033[0m "          // green-ish for function
	"\033[38;5;202mSRIDHAR - finished parsing\033[0m\n",  // orange-ish for message
	__FILE__, __LINE__, __func__);
  }
  if (result == 0) {
  ...
  fprintf(stderr,
	...
	"\033[38;5;220m%10s:%-5d\033[0m "      // yellow-ish for file:line
	"\033[38;5;82m%32s()\033[0m "          // green-ish for function
	"\033[38;5;202mSRIDHAR - finished standalone test program of library\033[0m\n",  // orange-ish for message
	__FILE__, __LINE__, __func__);
  return result;
}
